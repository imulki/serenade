...
from serenade.vocoder.layers import CausalConv1d, CausalConvTranspose1d
from serenade.vocoder.layers import HiFiGANResidualBlock as ResidualBlock
...
class HiFiGANGenerator(torch.nn.Module):
    ...
    def inference_batch(self, c, normalize_before=False):
        """Perform inference.
        ...
        if normalize_before:
            c = (c - self.mean) / self.scale
        c = self.forward(c.transpose(2, 1))
