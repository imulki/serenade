...
class TranscriptionModel(nn.Module):
    def __init__(self, config):
        ...
        (
            self.pitch_conv_stack,
            self.lang_conv_stack,
            self.pitch_rnn,
            self.lang_rnn,
            self.combined_rnn,
            self.combined_fc,
        ) = self._create_model(
            self.pitch_input_features,
            self.lang_input_features,
    ...
    def _create_model(
        self, pitch_input_features, lang_input_features, output_features, config
    ):
